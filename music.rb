...
def delete_artist (playlist, writer)
  playlist.delete(writer)
  return playlist
end
...
def add_song_and_artist (playlist,writer,song)
  playlist[writer] = song
  return playlist
end
